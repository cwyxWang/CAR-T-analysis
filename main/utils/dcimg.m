...
%         dc_sess_footer2 = nan;
    ...
    methods
        ...
        function DCIMGFile = dcimg_open(DCIMGFile,slices)
            ...
            strides = round(double([1,1,(DCIMGFile.dc_sess_header.bytes_per_img)/bd]));
...
%             DCIMGFile.data(DCIMGFile.dc_target_line,1:4,:) = DCIMGFile.dc_4px;
        ...
        function DCIMGFile = dcfunc_parse_header(DCIMGFile)
            ...
            % for wview
            DCIMGFile.dc_sess_header.ysize = DCIMGFile.dc_sess_header.ysize*2;
            DCIMGFile.dc_sess_header.bytes_per_img = DCIMGFile.dc_sess_header.bytes_per_img*2+32;
            %
